...
@dataclass
class SFTVideoScriptArguments(ScriptArguments):
    """
    Script arguments for the SFT video training script.
    """
    use_lora: bool = field(
        default=False,
            ...
            "content": [
                {
                    ...
                    example['data_type']: os.getcwd() + "/fish-mllms-dataset/" + example['path'],
                    # "max_pixels": 360*360,
                    "fps": 1.0
                },
                {
