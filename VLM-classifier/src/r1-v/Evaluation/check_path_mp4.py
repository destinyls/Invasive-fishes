...
def process_videos_from_json(json_file):
    ...
    for item in tqdm(data, desc="Processing videos", unit="item"):
        ...
        file_path = os.path.join("/home/yanglei/Video-R1/src/r1-v", file_path)
...
if __name__ == "__main__":
    ...
    process_videos_from_json("/home/yanglei/Video-R1/src/r1-v/Evaluation/Video-R1-eval/eval_videommmu.json")
