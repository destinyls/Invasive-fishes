...
def main():
    ...
    parser.add_argument("--input_dir", type=str, default="../data/fish-dataset/video", 
                        help="Input directory containing video folders")
    parser.add_argument("--output_det_dir", type=str, default="../data/fish-dataset/annotation_det", 
                        help="Output directory for detection JSON files")
    parser.add_argument("--output_mask_dir", type=str, default="../data/fish-dataset/annotation_mask", 
                        help="Output directory for mask files")
    parser.add_argument("--output_masked_image_dir", type=str, default="../data/fish-dataset/masked_image", 
                        help="Output directory for visualized mask images")
    parser.add_argument("--output_masked_video_dir", type=str, default="../data/fish-dataset/masked_video", 
                        help="Output directory for visualized mask videos")
    parser.add_argument("--output_instance_dir", type=str, default="../data/fish-instance-dataset/video", 
    ...
    parser.add_argument("--min_tracking_frames", type=int, default=100,
